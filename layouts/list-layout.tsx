...
export function ListLayout({
  ...
  return (
    <Container className="pt-4 lg:pt-12">
      <PageHeader
        title={title}
        description="Explore articles on web development, tech news, and solving algorithmic problems. Join us for relevant, up-to-date content tailored for developers and tech enthusiasts."
